...
const char* ei_classifier_inferencing_categories[] = { "idle", "updown", "wave" };
...
ei_dsp_config_spectral_analysis_t ei_dsp_config_2 = {
    ...
    2.5703125f, // float filter-cutoff
    6, // int filter-order
...
const ei_impulse_t impulse_706238_0 = {
    .project_id = 706238,
    .project_owner = "enzojunq",
    .project_name = "enzojunq-project-1",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 1,

    .nn_input_frame_size = 84,
    .raw_sample_count = 188,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 188 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 10.638297872340425,
    .frequency = 94,
...
ei_impulse_handle_t impulse_handle_706238_0 = ei_impulse_handle_t( &impulse_706238_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_706238_0;
